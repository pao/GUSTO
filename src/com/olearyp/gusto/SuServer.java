...
class SuServer extends AsyncTask<String, String, Void> {

	/**
	 * 
	 */
	private final Expsetup expsetup;

	/**
	 * @param expsetup
	 */
	SuServer(Expsetup expsetup) {
	...
	protected void onPreExecute() {
		pd = ProgressDialog.show(this.expsetup, "Working",
				"Starting process...", true, false);
	}

	public void execute(int command) {
		// TODO Auto-generated method stub
		this.execute(this.expsetup.getString(command));
	}
